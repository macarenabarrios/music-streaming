...
`
    ...
    nuevaLista.getElementsByTagName("i")[0].addEventListener("click",() => agregarAlCarrito(producto))
    nuevaLista.getElementsByTagName("buttom")[0].addEventListener("click",() => agregarAlCarrito(producto))
  });
}
crearTarjetasProductosInicio(dualipa);
